/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6e5de32e9e2a5eb35e940ce4f12c8f84)
// Runtime types generated with workerd@1.20250726.0 2025-08-05 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		kv: KVNamespace;
		CHARACTER_SLICE: "4";
		NODE_ENV: string;
		aed: AnalyticsEngineDataset;
		rateLimit: RateLimit;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHARACTER_SLICE" | "NODE_ENV">> {}
}
